...
* link:http://127.0.0.1:5500/ex1.html[簡單HTML的例子(同步)]
* link:http://127.0.0.1:5500/ex1-1.html[簡單HTML的例子(非同步)]
...
* 下面 link:http://127.0.0.1:5500/ex3.html[例子] 是 Ajax 的部分更新
